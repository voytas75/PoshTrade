...
.DESCRIPTION
The Get-SMA function calculates the Simple Moving Average (SMA) values based on the provided data points and period.
The Simple Moving Average is a widely used technical indicator that calculates the average of a specified number of data points.

.PARAMETER DataPoints
An array of double values representing the data points.

.PARAMETER Period
An integer representing the period for calculating the Simple Moving Average.
